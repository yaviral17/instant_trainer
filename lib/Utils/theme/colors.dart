...
class PColors {
  ...
  // App theme colors
  static const Color primaryLight = Color(0xffFD4E20);
  static const Color primaryDark = Color(0xFFFD4E20);
  static Color primary(context) {
    // not keeping variation for primary color
    return PHelper.isDarkMode(context) ? primaryDark : primaryLight;
  }

  //background colors
  static const Color backgroundLight = Color(0xFFF0F0F5);
  static const Color backgroundDark = Color(0xFF1b1e24);
  ...
  static const Color selectedBorderColor = Color(0xffFDDCC5);
}
